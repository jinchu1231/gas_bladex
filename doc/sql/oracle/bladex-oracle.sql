...
-- ----------------------------
INSERT INTO "BLADE_DATASOURCE" VALUES ('1161483357481541634', '1', 'mysql', 'com.mysql.cj.jdbc.Driver', 'jdbc:mysql://localhost:3306/bladex?useSSL=false&useUnicode=true&characterEncoding=utf-8&zeroDateTimeBehavior=convertToNull&transformedBitIsBoolean=true&serverTimezone=GMT%2B8&nullCatalogMeansCurrent=true&allowPublicKeyRetrieval=true', 'root', 'root', NULL, 'mysql', '1123598821738675201', '1123598813738675201', TO_DATE('2020-08-08 12:20:06', 'SYYYY-MM-DD HH24:MI:SS'), '1123598821738675201', TO_DATE('2020-08-08 12:20:06', 'SYYYY-MM-DD HH24:MI:SS'), '1', '0');
INSERT INTO "BLADE_DATASOURCE" VALUES ('1161483504353484802', '1', 'postgresql', 'org.postgresql.Driver', 'jdbc:postgresql://127.0.0.1:5432/bladex', 'postgres', '123456', NULL, 'postgresql', '1123598821738675201', '1123598813738675201', TO_DATE('2020-08-08 12:20:02', 'SYYYY-MM-DD HH24:MI:SS'), '1123598821738675201', TO_DATE('2020-08-08 12:20:02', 'SYYYY-MM-DD HH24:MI:SS'), '1', '0');
...
CREATE TABLE "BLADE_JOB_INFO" (
  ...
  "TIME_EXPRESSION" VARCHAR2(255 BYTE) ,
  "EXECUTE_TYPE" NUMBER(11) ,
  "PROCESSOR_TYPE" NUMBER(11) ,
  "PROCESSOR_INFO" VARCHAR2(255 BYTE) ,
  ...
  "DESIGNATED_WORKERS" VARCHAR2(255 BYTE) ,
  "MAX_WORKER_COUNT" NUMBER(11) ,
  "NOTIFY_USER_IDS" VARCHAR2(2000 BYTE) ,
  "ENABLE" NUMBER(11) ,
  "DISPATCH_STRATEGY" NUMBER(11) ,
  "LIFECYCLE" VARCHAR2(255 BYTE) ,
...
COMMENT ON COLUMN "BLADE_JOB_INFO"."JOB_PARAMS" IS '任务参数，Processor#process 方法入参 TaskContext对象的 jobParams 字段';
...
COMMENT ON COLUMN "BLADE_JOB_INFO"."INSTANCE_RETRY_NUM" IS '任务实例重试次数，整个任务失败时重试，代价大，不推荐使用';
COMMENT ON COLUMN "BLADE_JOB_INFO"."TASK_RETRY_NUM" IS 'Task 重试次数，每个子 Task 失败后单独重试，代价小，推荐使用';
COMMENT ON COLUMN "BLADE_JOB_INFO"."MIN_CPU_CORES" IS '最小可用 CPU 核心数，CPU 可用核心数小于该值的 Worker 将不会执行该任务，0 代表无任何限制';
...
COMMENT ON COLUMN "BLADE_JOB_INFO"."LIFECYCLE" IS '生命周期（预留，用于指定定时调度任务的生效时间范围）';
...
-- ----------------------------
--DROP TABLE "BLADE_JOB_SERVER";
CREATE TABLE "BLADE_JOB_SERVER" (
  "ID" NUMBER(20) NOT NULL ,
  "JOB_SERVER_NAME" VARCHAR2(50 BYTE) ,
  "JOB_SERVER_URL" VARCHAR2(255 BYTE) ,
  "JOB_APP_NAME" VARCHAR2(20 BYTE) ,
  "JOB_APP_PASSWORD" VARCHAR2(100 BYTE) ,
  "JOB_REMARK" VARCHAR2(255 BYTE) ,
  "CREATE_USER" NUMBER(20) ,
  "CREATE_DEPT" NUMBER(20) ,
  "CREATE_TIME" DATE ,
  "UPDATE_USER" NUMBER(20) ,
...
-- ----------------------------
INSERT INTO "BLADE_JOB_SERVER" VALUES (1741512022505590785, '任务调度服务器', '127.0.0.1:7700', 'blade-job', 'blade-job', '基础服务', 1123598821738675201, 1123598813738675201, TO_DATE('2024-01-01 01:29:57', 'SYYYY-MM-DD HH24:MI:SS'), 1123598821738675201, TO_DATE('2024-01-01 01:29:57', 'SYYYY-MM-DD HH24:MI:SS'), 1, 0);
COMMIT;
...
INSERT INTO "BLADE_MENU" VALUES ('1164733399669962401', '0', 'job', '任务管理', 'job', '/job', 'iconfont iconicon_cspace', '5', '1', '0', '1', NULL, NULL, '0');
...
-- ----------------------------
INSERT INTO "BLADE_OSS" VALUES ('1132486733992468482', '000000', '1', 'minio', 'http://127.0.0.1:9000', NULL, 'D99KGE6ZTQXSATTJWU24', 'QyVqGnhIQQE734UYSUFlGOZViE6+ZlDEfUG3NjhJ', 'bladex', NULL, NULL, NULL, '1123598821738675201', '1123598813738675201', TO_DATE('2019-05-26 11:20:52', 'SYYYY-MM-DD HH24:MI:SS'), '1123598821738675201', TO_DATE('2019-05-27 08:34:55', 'SYYYY-MM-DD HH24:MI:SS'), '2', '0');
INSERT INTO "BLADE_OSS" VALUES ('1132487155981393922', '000000', '2', 'qiniu', 'http://ps458elcs.bkt.clouddn.com', NULL, 'N_Loh1ngBqcJovwiAJqR91Ifj2vgOWHOf8AwBA_h', 'AuzuA1KHAbkIndCU0dB3Zfii2O3crHNODDmpxHRS', 'bladex', NULL, NULL, NULL, '1123598821738675201', '1123598813738675201', TO_DATE('2019-05-26 11:22:33', 'SYYYY-MM-DD HH24:MI:SS'), '1123598821738675201', TO_DATE('2019-05-26 23:27:56', 'SYYYY-MM-DD HH24:MI:SS'), '1', '0');
COMMIT;
