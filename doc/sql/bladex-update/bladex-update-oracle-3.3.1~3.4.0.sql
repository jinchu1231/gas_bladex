...
CREATE TABLE "BLADEX"."BLADE_JOB_SERVER" (
  ...
  "JOB_SERVER_NAME" VARCHAR2(50) ,
  "JOB_SERVER_URL" VARCHAR2(255) ,
  "JOB_APP_NAME" VARCHAR2(20) ,
  "JOB_APP_PASSWORD" VARCHAR2(100) ,
...
CREATE TABLE "BLADEX"."BLADE_JOB_INFO" (
 ...
 "TIME_EXPRESSION" VARCHAR2(255) ,
 "EXECUTE_TYPE" NUMBER(11) ,
 "PROCESSOR_TYPE" NUMBER(11) ,
 "PROCESSOR_INFO" VARCHAR2(255) ,
 ...
 "DESIGNATED_WORKERS" VARCHAR2(255) ,
 "MAX_WORKER_COUNT" NUMBER(11) ,
 "NOTIFY_USER_IDS" VARCHAR2(2000) ,
 "ENABLE" NUMBER(11) ,
