...
(
    "ID" BIGINT NOT NULL,
    "JOB_SERVER_NAME" VARCHAR(50) NULL,
    "JOB_SERVER_URL" VARCHAR(255) NULL,
    "JOB_APP_NAME" VARCHAR(20) NULL,
    "JOB_APP_PASSWORD" VARCHAR(100) NULL,
    "JOB_REMARK" VARCHAR(255) NULL,
...
COMMENT ON COLUMN "BLADEX"."BLADE_JOB_SERVER"."JOB_SERVER_URL" IS '任务服务器地址';
...
COMMENT ON COLUMN "BLADEX"."BLADE_JOB_SERVER"."JOB_REMARK" IS '任务备注';
...
COMMENT ON TABLE "BLADEX"."BLADE_JOB_INFO" IS '日志信息表';
...
COMMENT ON COLUMN "BLADEX"."BLADE_JOB_INFO"."JOB_PARAMS" IS '任务参数，Processor#process 方法入参 TaskContext 对象的 jobParams 字段';
...
COMMENT ON COLUMN "BLADEX"."BLADE_JOB_INFO"."INSTANCE_RETRY_NUM" IS 'instanceRetryNum	任务实例重试次数，整个任务失败时重试，代价大，不推荐使用';

COMMENT ON COLUMN "BLADEX"."BLADE_JOB_INFO"."TASK_RETRY_NUM" IS 'taskRetryNum	Task 重试次数，每个子 Task 失败后单独重试，代价小，推荐使用';

COMMENT ON COLUMN "BLADEX"."BLADE_JOB_INFO"."MIN_CPU_CORES" IS 'minCpuCores	最小可用 CPU 核心数，CPU 可用核心数小于该值的 Worker 将不会执行该任务，0 代表无任何限制';
...
COMMENT ON COLUMN "BLADEX"."BLADE_JOB_INFO"."LIFECYCLE" IS 'lifecycle	生命周期（预留，用于指定定时调度任务的生效时间范围）';
...
-- 新增任务菜单信息
-- -----------------------------------
INSERT INTO "BLADEX"."BLADE_MENU"("ID","PARENT_ID","CODE","NAME","ALIAS","PATH","SOURCE","SORT","CATEGORY","ACTION","IS_OPEN","COMPONENT","REMARK","IS_DELETED") VALUES(1164733399669962401,0,'job','任务管理','job','/job','iconfont iconicon_cspace',5,1,0,1,'',null,0);
INSERT INTO "BLADEX"."BLADE_MENU"("ID","PARENT_ID","CODE","NAME","ALIAS","PATH","SOURCE","SORT","CATEGORY","ACTION","IS_OPEN","COMPONENT","REMARK","IS_DELETED") VALUES(1164733399669962501,1164733399669962401,'jobserver','任务应用','menu','/job/jobserver','iconfont icon-shouji',1,1,0,1,null,null,0);
INSERT INTO "BLADEX"."BLADE_MENU"("ID","PARENT_ID","CODE","NAME","ALIAS","PATH","SOURCE","SORT","CATEGORY","ACTION","IS_OPEN","COMPONENT","REMARK","IS_DELETED") VALUES(1164733399669962502,1164733399669962501,'jobserver_add','新增','add','/job/jobserver/add','plus',1,2,1,1,null,null,0);
INSERT INTO "BLADEX"."BLADE_MENU"("ID","PARENT_ID","CODE","NAME","ALIAS","PATH","SOURCE","SORT","CATEGORY","ACTION","IS_OPEN","COMPONENT","REMARK","IS_DELETED") VALUES(1164733399669962503,1164733399669962501,'jobserver_edit','修改','edit','/job/jobserver/edit','form',2,2,2,1,null,null,0);
INSERT INTO "BLADEX"."BLADE_MENU"("ID","PARENT_ID","CODE","NAME","ALIAS","PATH","SOURCE","SORT","CATEGORY","ACTION","IS_OPEN","COMPONENT","REMARK","IS_DELETED") VALUES(1164733399669962504,1164733399669962501,'jobserver_delete','删除','delete','/api/blade-job/jobserver/remove','delete',3,2,3,1,null,null,0);
INSERT INTO "BLADEX"."BLADE_MENU"("ID","PARENT_ID","CODE","NAME","ALIAS","PATH","SOURCE","SORT","CATEGORY","ACTION","IS_OPEN","COMPONENT","REMARK","IS_DELETED") VALUES(1164733399669962505,1164733399669962501,'jobserver_view','查看','view','/job/jobserver/view','file-text',4,2,2,1,null,null,0);
INSERT INTO "BLADEX"."BLADE_MENU"("ID","PARENT_ID","CODE","NAME","ALIAS","PATH","SOURCE","SORT","CATEGORY","ACTION","IS_OPEN","COMPONENT","REMARK","IS_DELETED") VALUES(1164733399669962601,1164733399669962401,'jobinfo','任务配置','menu','/job/jobinfo','iconfont icon-dongtai',1,1,0,1,null,null,0);
INSERT INTO "BLADEX"."BLADE_MENU"("ID","PARENT_ID","CODE","NAME","ALIAS","PATH","SOURCE","SORT","CATEGORY","ACTION","IS_OPEN","COMPONENT","REMARK","IS_DELETED") VALUES(1164733399669962602,1164733399669962601,'jobinfo_add','新增','add','/job/jobinfo/add','plus',1,2,1,1,null,null,0);
INSERT INTO "BLADEX"."BLADE_MENU"("ID","PARENT_ID","CODE","NAME","ALIAS","PATH","SOURCE","SORT","CATEGORY","ACTION","IS_OPEN","COMPONENT","REMARK","IS_DELETED") VALUES(1164733399669962603,1164733399669962601,'jobinfo_edit','修改','edit','/job/jobinfo/edit','form',2,2,2,1,null,null,0);
INSERT INTO "BLADEX"."BLADE_MENU"("ID","PARENT_ID","CODE","NAME","ALIAS","PATH","SOURCE","SORT","CATEGORY","ACTION","IS_OPEN","COMPONENT","REMARK","IS_DELETED") VALUES(1164733399669962604,1164733399669962601,'jobinfo_delete','删除','delete','/api/blade-job/jobinfo/remove','delete',3,2,3,1,null,null,0);
INSERT INTO "BLADEX"."BLADE_MENU"("ID","PARENT_ID","CODE","NAME","ALIAS","PATH","SOURCE","SORT","CATEGORY","ACTION","IS_OPEN","COMPONENT","REMARK","IS_DELETED") VALUES(1164733399669962605,1164733399669962601,'jobinfo_view','查看','view','/job/jobinfo/view','file-text',4,2,2,1,null,null,0);
