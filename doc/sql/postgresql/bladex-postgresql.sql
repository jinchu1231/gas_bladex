...
-- ----------------------------
BEGIN;
INSERT INTO "blade_job_server" VALUES (1741512022505590785, '任务调度服务器', '127.0.0.1:7700', 'blade-job', 'blade-job', '基础服务', 1123598821738675201, 1123598813738675201, '2024-01-01 01:29:57', 1123598821738675201, '2024-01-01 01:29:57', 1, 0);
COMMIT;
...
INSERT INTO "blade_menu" VALUES (1164733399669962401, 0, 'job', '任务管理', 'job', '/job', 'iconfont iconicon_cspace', 5, 1, 0, 1, '', NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733399669962501, 1164733399669962401, 'jobserver', '任务应用', 'menu', '/job/jobserver', 'iconfont icon-shouji', 1, 1, 0, 1, NULL, NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733399669962502, 1164733399669962501, 'jobserver_add', '新增', 'add', '/job/jobserver/add', 'plus', 1, 2, 1, 1, NULL, NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733399669962503, 1164733399669962501, 'jobserver_edit', '修改', 'edit', '/job/jobserver/edit', 'form', 2, 2, 2, 1, NULL, NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733399669962504, 1164733399669962501, 'jobserver_delete', '删除', 'delete', '/api/blade-job/jobserver/remove', 'delete', 3, 2, 3, 1, NULL, NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733399669962505, 1164733399669962501, 'jobserver_view', '查看', 'view', '/job/jobserver/view', 'file-text', 4, 2, 2, 1, NULL, NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733399669962601, 1164733399669962401, 'jobinfo', '任务配置', 'menu', '/job/jobinfo', 'iconfont icon-dongtai', 1, 1, 0, 1, NULL, NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733399669962602, 1164733399669962601, 'jobinfo_add', '新增', 'add', '/job/jobinfo/add', 'plus', 1, 2, 1, 1, NULL, NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733399669962603, 1164733399669962601, 'jobinfo_edit', '修改', 'edit', '/job/jobinfo/edit', 'form', 2, 2, 2, 1, NULL, NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733399669962604, 1164733399669962601, 'jobinfo_delete', '删除', 'delete', '/api/blade-job/jobinfo/remove', 'delete', 3, 2, 3, 1, NULL, NULL, 0);
INSERT INTO "blade_menu" VALUES (1164733399669962605, 1164733399669962601, 'jobinfo_view', '查看', 'view', '/job/jobinfo/view', 'file-text', 4, 2, 2, 1, NULL, NULL, 0);
COMMIT;
...
-- ----------------------------
ALTER TABLE "blade_job_info" ADD CONSTRAINT "blade_job_info_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table blade_job_server
-- ----------------------------
ALTER TABLE "blade_job_server" ADD CONSTRAINT "blade_job_server_pkey" PRIMARY KEY ("id");
